...
class Document(object):
    """
    Basic representation of a document - including a unique identifier (index ID), a title, 
    document content (body), and an additional identifier (e.g. collection ID).
...
class Response(object):
    """
    Basic representation of a response - includes content and a judgment.
    """
    def __init__(self, content=None, judgment=-1):
        """
        Instantiates an instance of the Response.
        """
        self.content = content
    ...
    def __str__(self):
        """
        Returns a string representation of a given instance of Response.
        """
        return "<Response Content: '{0}' Judgment: '{1}'>".format(self.content, self.judgment)
